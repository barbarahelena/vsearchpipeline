...
def nfCoreLogo(monochrome_logs = true) {
    ...
    def lines = [
" _   _ _____ _____  ___  ______  _____  _   _  __ _               ",
"| | | /  ___|  ___|/ _ \\ | ___ \\/  __ \\| | | |/ _| |              ",
"| | | \\ `--.| |__ / /_\\ \\| |_/ /| /  \\/| |_| | |_| | _____      __",
"| | | |`--. \\  __||  _  ||    / | |    |  _  |  _| |/ _ \\ \\ /\\ / /",
"\\ \\_/ /\\__/ / |___| | | || |\\ \\ | \\__/\\| | | | | | | (_) \\ V  V / ",
" \\___/\\____/\\____/\\_| |_/\\_| \\_| \\____/\\_| |_/_| |_|\\___/ \\_/\\_/  "
    ]
    ...
    logoBuilder.append("\n")
    logoBuilder.append(monochrome_logs ? "vsearchpipeline: VSEARCH amplicon pipeline in Nextflow\n" :
                                         "\u001B[38;5;184mvsearchpipeline: VSEARCH amplicon pipeline in Nextflow\u001B[0m\n")
